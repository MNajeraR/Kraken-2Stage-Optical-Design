...
Monte_Carlo_Result = MOSCL.Optimizer([Telescope_f85_FR,Rays])
...
centers = [236.9149988122892, -101962.15840992171, 10031.8118438895, 485.50785903555726, 185.6050577679964]
ro = MOSCL.Random_RO(1000, centers)

# Perform Gaussian-based Monte Carlo optimization
p_result = ro.Gaussian_optimization(10, Monte_Carlo_Result.Set_RcValues)
R1, R2, R3, R4, d4 = p_result
...
for fx, fy, name in fields:
    ...
    # Plot the diagram
    geo_r, rms_r = Meq.plot_spot_diagram(Xa, Ya, Xb, Yb, Xc, Yc, xairy, yairy, name, "Monte_Carlo_Method")
