...
d_1 = Prx_data.d_1
d_2 = 4674.563020564023
d_3 = 18.582831370781626


# Third Order
R_1 = 92.72020148973196
R_2 = -99927.12874207606
R_3 = 9992.712931548076
R_4 = 172.79648824674388

d_4 = 108.15473780133613
...
Classic_Result = MOSCL.Optimizer([Telescope_f85_FR,Rays])
...
Rairy = (1.22 * (W / 1000) * Telescope_f85_FR.EFFL) / (M1.Diameter)
num_segmentos = 100
...
for fx, fy, name in fields:
    ...
    # Plot the diagram
    geo_r, rms_r = Meq.plot_spot_diagram(Spot_Set, field_Set, xairy, yairy, name, "Classic_Method")
