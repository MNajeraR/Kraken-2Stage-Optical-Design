...
import numpy as np
import scipy
from utils import Paraxial_Cal
...
Prx_data = Paraxial_Cal(per_red)  # Initialize paraxial calculations
...
B_sistem = scipy.optimize.least_squares(Prx_data.Prx_equation, initial_guess, bounds=bounds, 
                                        verbose=0)
