...
# Obtained through the script Three_Lenses_Third_Order_Focal_Reducer_Ch2.py
...
name_save = f"PGMF_Three_Lens_Classic_{L1a.Glass}_{L2a.Glass}_{L1a.Glass}_Ch2"
