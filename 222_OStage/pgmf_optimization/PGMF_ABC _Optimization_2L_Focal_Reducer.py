...
ABC_Result = Optimizer([Telescope_f85_FR, Rays])
...
search_boundaries = (
    [R_1 - R_1*Delta_search, R_2 + R_2*Delta_search,
     R_3 + R_3*Delta_search, R_4 - R_4*Delta_search, 
     d_4 - d_4*Delta_search], 
    [R_1 + R_1*Delta_search, R_2 - R_2*Delta_search, 
     R_3 - R_3*Delta_search, R_4 + R_4*Delta_search,
     d_4 + d_4*Delta_search]
)
...
name_save = f"PGMF_ABC_{L1a.Glass}_{L2a.Glass}"
...
EE_Example_information = plot_all_EE_for_fields(
                            ...
                            filename=f"EE_ABC_{L1a.Glass}_{L2a.Glass}_fields.pdf"
                            )   
