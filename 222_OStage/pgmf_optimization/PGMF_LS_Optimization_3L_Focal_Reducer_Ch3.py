...
file_path =  f"Optimized_Parameters/Third_Order_Parameters_{glass_tag}_Ch3.txt"
...
# Obtained through the script Three_Lenses_Third_Order_Focal_Reducer_Ch3.py
...
W = 0.8067               # Reference wavelength in micrometers
...
Classic_Result.W = W
Classic_Result.W_1 = RW[0]
Classic_Result.W_3 = RW[2]
...
file_path = os.path.join(folder_name,f"PGMF_LS_Parameters_{L1a.Glass}_{L2a.Glass}_{L3a.Glass}_Ch3.txt")

with open(file_path, "w", encoding="utf-8") as f:
    f.write(f"PGMF_LS_Parameters_{L1a.Glass}_{L2a.Glass}_{L3a.Glass}_Ch3= [\n")
...
name_save = f"PGMF_Three_Lens_Classic_{L1a.Glass}_{L2a.Glass}_{L1a.Glass}_Ch3"
...
List_Radius, meta = run_spots_for_fields(
    ...
    box_include_airy=False, save_dir = 'Images\SPT_Diagrams_Article_CS\Ch3')


EE_Example_information = plot_all_EE_for_fields(
                            Pup, Rays, Field_ccd, RW, save_dir='Images\EE_Diagrams_Article_CS\Ch3',
                            show_r50 = True, save = True,  show=True,
                            filename=f"EE_PGMF_Three_Lens_Classic_{L1a.Glass}_{L2a.Glass}_{L1a.Glass}_Ch3.pdf",
