...
file_path = (
    ...
    / f"Third_Order_Parameters_{glass_tag}_Ch3.txt"
)
...
file_path = (
    output_dir
    / f"PGMF_LS_Parameters_{L1a.Glass}_{L2a.Glass}_{L3a.Glass}_Ch3.txt"
)

with open(file_path, "w", encoding="utf-8") as f:

    f.write(
        f"PGMF_LS_Parameters_{L1a.Glass}_{L2a.Glass}_{L3a.Glass}_Ch3= [\n"
    )
...
List_Radius, meta = run_spots_for_fields(
    ...
    box_include_airy=False, save_dir = 'figures\SPT_Diagrams\Ch3')


EE_Example_information = plot_all_EE_for_fields(
                            Pup, Rays, Field_ccd, RW, save_dir='figures\EE_Diagrams\Ch3',
