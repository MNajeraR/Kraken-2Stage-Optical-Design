...
def apply_system_actualization_3L(
    system,
    R3, R4, R5, R6,
    n_l2, d_lens2,
    n_l3, d_lens3,
    ...
    H1_a, H2_a = Prin_Plane(n_l2, R3, R4, d_lens2)
    H1_b, H2_b = Prin_Plane(n_l3, R5, R6, d_lens3)

    # --- 3) Update optical train thicknesses
    system.SDT[2].Thickness = TO_data.d_3 - H1_a
    system.SDT[4].Thickness = TO_data.d_4 - H2_a - H1_b
    system.SDT[6].Thickness = d5 - H2_b
