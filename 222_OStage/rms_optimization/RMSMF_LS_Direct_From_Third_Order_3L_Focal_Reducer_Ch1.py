...
# Obtained directly from the third-order SPD solution
...
# EFFL obtained from the third-order starting configuration
EFFL_Third_Order = Telescope_f85_FR.EFFL 
...
print("======================================")
print("Initial RMS radius from the third-order starting configuration:")
print(f"RMS (Field 0.0, 0.0 deg): {deltaZRMS*1000:.2f} µm")
print(f"Effective Focal Length: {EFFL_Third_Order:.2f}")
print("======================================")
print('')
...
Set_RMS_Direct_Opt = [R1, R2, R3, R4, R5, R6, Telescope_f85_FR.SDT[8].Thickness]
...
file_path = (
    output_dir
    / f"RMSMF_Direct_From_Third_Order_Parameters_{L1a.Glass}_{L2a.Glass}_{L3a.Glass}_Ch1.txt"
)

with open(file_path, "w", encoding="utf-8") as f:

    f.write(
        f"RMSMF_Direct_From_Third_Order_Parameters_{L1a.Glass}_{L2a.Glass}_{L3a.Glass}_Ch1= [\n"
    )

    for value in Set_RMS_Direct_Opt:
        f.write(f"{value:.8f},\n")
...
name_save = f"RMS_Direct_From_Third_Order_{L1a.Glass}_{L2a.Glass}_{L3a.Glass}_Ch1"
...
EE_Example_information = plot_all_EE_for_fields(
                            ...
                            filename=f"EE_RMS_Direct_From_Third_Order_{L1a.Glass}_{L2a.Glass}_{L3a.Glass}_Ch1.pdf"
                            )   
